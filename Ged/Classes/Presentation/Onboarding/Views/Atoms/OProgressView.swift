...
private extension OProgressView {
    func createCircularPath() {
        ...
        circleLayer.strokeColor = UIColor(integralRed: 61, green: 148, blue: 245, alpha: 0.3).cgColor
        ...
        progressLayer.strokeColor = UIColor(integralRed: 61, green: 148, blue: 245).cgColor
